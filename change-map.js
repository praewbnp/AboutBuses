...
function changeMap24() {
  ...
  document.getElementById("button29").style.color = "black";
  document.getElementById("button39").style.backgroundColor = "white";
  document.getElementById("button39").style.color = "black";
  document.getElementById("button59").style.backgroundColor = "white";
  document.getElementById("button59").style.color = "black";
  document.getElementById("button104").style.backgroundColor = "white";
  document.getElementById("button104").style.color = "black";
  document.getElementById("button510").style.backgroundColor = "white";
...
function changeMap29() {
  ...
  document.getElementById("button24").style.color = "black";
  document.getElementById("button39").style.backgroundColor = "white";
  document.getElementById("button39").style.color = "black";
  document.getElementById("button59").style.backgroundColor = "white";
  document.getElementById("button59").style.color = "black";
